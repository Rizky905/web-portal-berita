<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$config['grocery_crud_file_upload_allow_file_types'] 		= 'gif|jpeg|jpg|png|tiff|ogg|wav|mp4|m4v|mov|wmv|flv|avi|mpg|ogv|3gp|3g2';
	...
	$config['grocery_crud_default_text_editor'] = 'trumbowyg';
