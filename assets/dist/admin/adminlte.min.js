! function (e, t) {
	...
	function r(e, t, n) {
		...
		if ("string" == typeof t) {
			if (be.test(t)) return pe.filter(t, e, n);
			t = pe.filter(t, e)
		}
	...
	function v(e, t, n, r, i) {
		for (var o, a, s, u, l, c, d, f = e.length, v = p(t), y = [], x = 0; f > x; x++)
			...
			for (u = u || v.appendChild(t.createElement("div")), l = (Oe.exec(a) || ["", ""])[1].toLowerCase(), d = We[l] || We._default, u.innerHTML = d[1] + pe.htmlPrefilter(a) + d[2], o = d[0]; o--;) u = u.lastChild;
			if (!de.leadingWhitespace && Pe.test(a) && y.push(t.createTextNode(Pe.exec(a)[0])), !de.tbody)
				for (a = "table" !== l || $e.test(a) ? "<table>" !== d[1] || $e.test(a) ? 0 : u : u.firstChild, o = a && a.childNodes.length; o--;) pe.nodeName(c = a.childNodes[o], "tbody") && !c.childNodes.length && a.removeChild(c);
		...
		for (u && v.removeChild(u), de.appendChecked || pe.grep(h(y, "input"), m), x = 0; a = y[x++];)
			...
			for (o = 0; a = u[o++];) Re.test(a.type || "") && n.push(a);
		return u = null, v
	}
	...
	function S(e, t, n, r) {
		...
		var i, o, a, s, u, l, c = 0,
			...
			p = t[0],
			g = pe.isFunction(p);
		if (g || d > 1 && "string" == typeof p && !de.checkClone && Qe.test(p)) return e.each(function (i) {
			var o = e.eq(i);
		...
		if (d && (l = v(t, e[0].ownerDocument, !1, e, r), i = l.firstChild, 1 === l.childNodes.length && (l = i), i || r)) {
			...
			if (a)
				for (u = s[s.length - 1].ownerDocument, pe.map(s, E), c = 0; a > c; c++) o = s[c], Re.test(o.type || "") && !pe._data(o, "globalEval") && pe.contains(u, o) && (o.src ? pe._evalUrl && pe._evalUrl(o.src) : pe.globalEval((o.text || o.textContent || o.innerHTML || "").replace(Ze, "")));
			l = i = null
		}
		return e
	}
	...
	function j(e) {
		var t = re,
			n = rt[e];
		return n || (n = D(e, t), "none" !== n && n || (nt = (nt || pe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (nt[0].contentWindow || nt[0].contentDocument).document, t.write(), t.close(), n = D(e, t), nt.detach()), rt[e] = n), n
	}
	...
	function q(e, t) {
		for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = pe._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && _e(r) && (o[a] = pe._data(r, "olddisplay", j(r.nodeName)))) : (i = _e(r), (n && "none" !== n || !i) && pe._data(r, "olddisplay", i ? n : pe.css(r, "display"))));
	...
	function M(e, t, n) {
		...
		if (0 >= i || null == i) {
			if (i = lt(e, t, o), (0 > i || null == i) && (i = e.style[t]), ot.test(i)) return i;
	...
	function W(e, t, n) {
		...
		})), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], l = pe.css(e, "display"), "inline" === ("none" === l ? pe._data(e, "olddisplay") || j(e.nodeName) : l) && "none" === pe.css(e, "float") && (de.inlineBlockNeedsLayout && "inline" !== j(e.nodeName) ? f.zoom = 1 : f.display = "inline-block")), n.overflow && (f.overflow = "hidden", de.shrinkWrapBlocks() || c.always(function () {
	...
	function $(e, t, n) {
		var r, i, o = 0,
			...
			u = function () {
				if (i) return !1;
				for (var t = xt || R(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; u > a; a++) l.tweens[a].run(o);
	...
	function K(e, t, n, r) {
		...
		if (pe.isArray(t)) pe.each(t, function (t, i) {
			n || Xt.test(e) ? r(e, i) : K(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r)
		});
	...
	var ge = function (e) {
		...
		function g(e, t, n, i, o, a) {
			return i && !i[O] && (i = g(i)), o && !o[O] && (o = g(o, a)), r(function (r, a, s, u) {
				var l, c, d, f = [],
					...
					x = n ? o || (r ? e : m || i) ? [] : a : y;
				if (n && n(y, x, s, u), i)
					for (l = h(x, g), i(l, [], s, u), c = l.length; c--;)(d = l[c]) && (x[g[c]] = !(y[g[c]] = d));
				if (r) {
					if (o || e) {
						if (o) {
			...
			var i = n.length > 0,
				...
				a = function (r, a, s, u, l) {
					...
					for (l && (k = a === j || a || l); g !== T && null != (c = x[g]); g++) {
						if (o && c) {
							for (d = 0, a || c.ownerDocument === j || (D(c), s = !H); f = e[d++];)
								if (f(c, a || j, s)) {
									u.push(c);
									break
								}
		...
		x = t.support = {}, T = t.isXML = function (e) {
			...
			return r !== j && 9 === r.nodeType && r.documentElement ? (j = r, L = j.documentElement, H = !T(j), (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", be, !1) : n.attachEvent && n.attachEvent("onunload", be)), x.attributes = i(function (e) {
				...
				return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === j || e.ownerDocument === R && M(R, e) ? -1 : t === j || t.ownerDocument === R && M(R, t) ? 1 : S ? K(S, e) - K(S, t) : 0 : 4 & n ? -1 : 1)
			} : function (e, t) {
				if (e === t) return A = !0, 0;
				var n, r = 0,
					i = e.parentNode,
					...
					return 1 === r && 0 === i ? function (e) {
						...
						if (m) {
							...
							if (h = [a ? m.firstChild : m.lastChild], a && y) {
								for (f = m, d = f[O] || (f[O] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), l = c[e] || [], p = l[0] === P && l[1], x = p && l[2], f = p && m.childNodes[p]; f = ++p && f && f[g] || (x = p = 0) || h.pop();)
									if (1 === f.nodeType && ++x && f === t) {
										c[e] = [P, p, x];
										break
									}
							} else if (y && (f = t, d = f[O] || (f[O] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), l = c[e] || [], p = l[0] === P && l[1], x = p),
								x === !1)
								for (;
	...
	(pe.fn.init = function (e, t, n) {
		...
		if (n = n || we, "string" == typeof e) {
			...
			if (r[1]) {
				if (t = t instanceof pe ? t[0] : t, pe.merge(this, pe.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : re, !0)), xe.test(r[1]) && pe.isPlainObject(t))
	...
	pe.fn.extend({
		...
		closest: function (e, t) {
			for (var n, r = 0, i = this.length, o = [], a = ye.test(e) || "string" != typeof e ? pe(e, t || this.context) : 0; i > r; r++)
		...
		pe.fn[e] = function (n, r) {
			...
			return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = pe.filter(r, i)), this.length > 1 && (Ee[e] || (i = pe.uniqueSort(i)), Ce.test(e) && (i = i.reverse())), this.pushStack(i)
		}
	});
	var Ne = /\S+/g;
	...
	pe.fn.ready = function (e) {
		...
		ready: function (e) {
			(e === !0 ? --pe.readyWait : pe.isReady) || (pe.isReady = !0, e !== !0 && --pe.readyWait > 0 || (ke.resolveWith(re, [pe]), pe.fn.triggerHandler && (pe(re).triggerHandler("ready"), pe(re).off("ready"))))
		}
	}), pe.ready.promise = function (t) {
		if (!ke)
			if (ke = pe.Deferred(), "complete" === re.readyState || "loading" !== re.readyState && !re.documentElement.doScroll) e.setTimeout(pe.ready);
	...
	var Se;
	for (Se in pe(de)) break;
	de.ownFirst = "0" === Se, de.inlineBlockNeedsLayout = !1, pe(function () {
			var e, t, n, r;
	...
	pe.event = {
		...
		add: function (e, t, n, r, i) {
			...
			if (m) {
				for (n.handler && (u = n, n = u.handler, i = u.selector), n.guid || (n.guid = pe.guid++), (a = m.events) || (a = m.events = {}), (c = m.handle) || (c = m.handle = function (e) {
					...
					}, c.elem = e), t = (t || "").match(Ne) || [""], s = t.length; s--;) o = Ye.exec(t[s]) || [], p = g = o[1], h = (o[2] || "").split(".").sort(), p && (l = pe.event.special[p] || {}, p = (i ? l.delegateType : l.bindType) || p, l = pe.event.special[p] || {}, d = pe.extend({
					type: p,
					origType: g,
					data: r,
					handler: n,
		...
		remove: function (e, t, n, r, i) {
			...
			if (m && (c = m.events)) {
				for (t = (t || "").match(Ne) || [""], l = t.length; l--;)
					if (s = Ye.exec(t[l]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p) {
		...
		trigger: function (t, n, r, i) {
			...
			if (s = c = r = r || re, 3 !== r.nodeType && 8 !== r.nodeType && !Ve.test(p + pe.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[pe.expando] ? t : new pe.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : pe.makeArray(n, [t]), l = pe.event.special[p] || {}, i || !l.trigger || l.trigger.apply(r, n) !== !1)) {
				...
				for (d = 0;
					(s = f[d++]) && !t.isPropagationStopped();) t.type = d > 1 ? u : l.bindType || p, o = (pe._data(s, "events") || {})[t.type] && pe._data(s, "handle"), o && o.apply(s, n), (o = a && s[a]) && o.apply && Ae(s) && (t.result = o.apply(s, n), t.result === !1 && t.preventDefault());
				if (t.type = p, !i && !t.isDefaultPrevented() && (!l._default || l._default.apply(f.pop(), n) === !1) && Ae(r) && a && r[p] && !pe.isWindow(r)) {
			...
			if (s[0] = e, e.delegateTarget = this, !l.preDispatch || l.preDispatch.call(this, e) !== !1) {
				for (a = pe.event.handlers.call(this, e, u), t = 0;
					...
					for (e.currentTarget = i.elem, n = 0;
						(o = i.handlers[n++]) && !e.isImmediatePropagationStopped();) e.rnamespace && !e.rnamespace.test(o.namespace) || (e.handleObj = o, e.data = o.data, void 0 !== (r = ((pe.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
		...
		fix: function (e) {
			...
			var t, n, r, i = e.type,
				o = e,
				a = this.fixHooks[i];
			for (a || (this.fixHooks[i] = a = Ue.test(i) ? this.mouseHooks : Xe.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new pe.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
		...
		setup: function () {
			return ze.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (pe.event.add(this, "propertychange._change", function (e) {
				"checked" === e.originalEvent.propertyName && (this._justChanged = !0)
			}), pe.event.add(this, "click._change", function (e) {
				this._justChanged && !e.isTrigger && (this._justChanged = !1), pe.event.simulate("change", this, e)
			})), !1) : void pe.event.add(this, "beforeactivate._change", function (e) {
				var t = e.target;
				ze.test(t.nodeName) && !pe._data(t, "change") && (pe.event.add(t, "change._change", function (e) {
		...
		teardown: function () {
			return pe.event.remove(this, "._change"), !ze.test(this.nodeName)
		}
	}), de.focusin || pe.each({
		focus: "focusin",
		blur: "focusout"
	...
	var Je = new RegExp("<(?:" + Be + ")[\\s/>]", "i"),
		Ge = /<script|<style|<link/i,
		Qe = /checked\s*(?:[^=]|=\s*.checked.)/i,
		Ke = /^true\/(.*)/,
		Ze = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
		et = p(re),
		tt = et.appendChild(re.createElement("div"));
	pe.extend({
		...
		clone: function (e, t, n) {
			...
			if (de.html5Clone || pe.isXMLDoc(e) || !Je.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (tt.innerHTML = e.outerHTML, tt.removeChild(o = tt.firstChild)), !(de.noCloneEvent && de.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e)))
		...
		html: function (e) {
			return Fe(this, function (e) {
				...
				if ("string" == typeof e && !Ge.test(e) && (de.htmlSerialize || !Je.test(e)) && (de.leadingWhitespace || !Pe.test(e)) && !We[(Oe.exec(e) || ["", ""])[1].toLowerCase()]) {
	...
	var ut, lt, ct = /^(top|right|bottom|left)$/;
	e.getComputedStyle ? (ut = function (t) {
		var n = t.ownerDocument.defaultView;
		return n && n.opener || (n = e), n.getComputedStyle(t)
	}, lt = function (e, t, n) {
		var r, i, o, a, s = e.style;
		return n = n || ut(e), a = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== a && void 0 !== a || pe.contains(e.ownerDocument, e) || (a = pe.style(e, t)), n && !de.pixelMarginRight() && ot.test(a) && it.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o), void 0 === a ? a : a + ""
	}) : st.currentStyle && (ut = function (e) {
		return e.currentStyle
	}, lt = function (e, t, n) {
		var r, i, o, a, s = e.style;
		return n = n || ut(e), a = n ? n[t] : void 0, null == a && s && s[t] && (a = s[t]), ot.test(a) && !ct.test(t) && (r = s.left, i = e.runtimeStyle, o = i && i.left, o && (i.left = e.currentStyle.left), s.left = "fontSize" === t ? "1em" : a, a = s.pixelLeft + "px", s.left = r, o && (i.left = o)), void 0 === a ? a : a + "" || "auto"
	});
	var dt = /alpha\([^)]*\)/i,
		ft = /opacity\s*=\s*([^)]*)/i,
		pt = /^(none|table(?!-c[ea]).+)/,
	...
	pe.extend({
		...
		style: function (e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				if (o = typeof n, "string" === o && (i = He.exec(n)) && i[1] && (n = f(e, t, i), o = "number"), null != n && n === n && ("number" === o && (n += i && i[3] || (pe.cssNumber[s] ? "" : "px")), de.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r))))) try {
					u[t] = n
				} catch (e) {}
			}
		},
		css: function (e, t, n, r) {
			var i, o, a, s = pe.camelCase(t);
			return t = pe.cssProps[s] || (pe.cssProps[s] = H(s) || s), a = pe.cssHooks[t] || pe.cssHooks[s], a && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = lt(e, t, r)), "normal" === o && t in mt && (o = mt[t]), "" === n || n ? (i = parseFloat(o), n === !0 || isFinite(i) ? i || 0 : o) : o
		}
	}), pe.each(["height", "width"], function (e, t) {
		pe.cssHooks[t] = {
			get: function (e, n, r) {
				return n ? pt.test(pe.css(e, "display")) && 0 === e.offsetWidth ? at(e, gt, function () {
					return M(e, t, r)
				}) : M(e, t, r) : void 0
			},
			set: function (e, n, r) {
		...
		set: function (e, t) {
			...
			n.zoom = 1, (t >= 1 || "" === t) && "" === pe.trim(o.replace(dt, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || r && !r.filter) || (n.filter = dt.test(o) ? o.replace(dt, i) : o + " " + i)
		}
		...
		return t ? (parseFloat(lt(e, "marginLeft")) || (pe.contains(e.ownerDocument, e) ? e.getBoundingClientRect().left - at(e, {
			marginLeft: 0
		}, function () {
		...
		}, it.test(e) || (pe.cssHooks[e + t].set = _)
	}), pe.fn.extend({
		css: function (e, t) {
			return Fe(this, function (e, t, n) {
				var r, i, o = {},
					a = 0;
				if (pe.isArray(t)) {
					for (r = ut(e), i = t.length; i > a; a++) o[t[a]] = pe.css(e, t[a], !1, r);
					return o
				}
	...
	pe.Animation = pe.extend($, {
			...
			var e, t = pe.timers,
				n = 0;
			for (xt = pe.now(); n < t.length; n++)(e = t[n])() || t[n] !== e || t.splice(n--, 1);
			t.length || pe.fx.stop(), xt = void 0
		}, pe.fx.timer = function (e) {
			pe.timers.push(e), e() ? pe.fx.start() : pe.timers.pop()
		}, pe.fx.interval = 13, pe.fx.start = function () {
			bt || (bt = e.setInterval(pe.fx.tick, pe.fx.interval))
		}, pe.fx.stop = function () {
	...
	pe.fn.extend({
		val: function (e) {
			...
			})) : i ? (t = pe.valHooks[i.type] || pe.valHooks[i.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : (n = i.value, "string" == typeof n ? n.replace(/\r/g, "") : null == n ? "" : n)) : void 0
		}
	}), pe.extend({
		valHooks: {
			option: {
				get: function (e) {
					...
					return null != t ? t : pe.trim(pe.text(e)).replace(/[\x20\t\r\n\f]+/g, " ")
				}
			},
			select: {
				get: function (e) {
	...
	var Ct, Et, Nt = pe.expr.attrHandle,
	...
	pe.fn.extend({
		...
		attr: function (e, t, n) {
			var r, i, o = e.nodeType;
			if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? pe.prop(e, t, n) : (1 === o && pe.isXMLDoc(e) || (t = t.toLowerCase(), i = pe.attrHooks[t] || (pe.expr.match.bool.test(t) ? Et : Ct)), void 0 !== n ? null === n ? void pe.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in i && null !== (r = i.get(e, t)) ? r : (r = pe.find.attr(e, t), null == r ? void 0 : r))
		},
		attrHooks: {
			type: {
				set: function (e, t) {
		...
		removeAttr: function (e, t) {
			var n, r, i = 0,
				o = t && t.match(Ne);
			if (o && 1 === e.nodeType)
				for (; n = o[i++];) r = pe.propFix[n] || n, pe.expr.match.bool.test(n) ? At && St || !kt.test(n) ? e[r] = !1 : e[pe.camelCase("default-" + n)] = e[r] = !1 : pe.attr(e, n, ""), e.removeAttribute(St ? n : r)
		}
	}), Et = {
		set: function (e, t, n) {
			return t === !1 ? pe.removeAttr(e, n) : At && St || !kt.test(n) ? e.setAttribute(!St && pe.propFix[n] || n, n) : e[pe.camelCase("default-" + n)] = e[n] = !0, n
		}
	}, pe.each(pe.expr.match.bool.source.match(/\w+/g), function (e, t) {
		var n = Nt[t] || pe.find.attr;
	...
	}), At && St || (pe.attrHooks.value = {
		set: function (e, t, n) {
			return pe.nodeName(e, "input") ? void(e.defaultValue = t) : Ct && Ct.set(e, t, n)
		}
	}), St || (Ct = {
		set: function (e, t, n) {
	...
	pe.fn.extend({
		addClass: function (e) {
			...
			if ("string" == typeof e && e)
				for (t = e.match(Ne) || []; n = this[u++];)
					if (i = z(n), r = 1 === n.nodeType && (" " + i + " ").replace(Lt, " ")) {
		...
		toggleClass: function (e, t) {
			...
			return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : pe.isFunction(e) ? this.each(function (n) {
				...
				var t, r, i, o;
				if ("string" === n)
					for (r = 0, i = pe(this), o = e.match(Ne) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
		...
		hasClass: function (e) {
			var t, n, r = 0;
			for (t = " " + e + " "; n = this[r++];)
				if (1 === n.nodeType && (" " + z(n) + " ").replace(Lt, " ").indexOf(t) > -1) return !0;
			return !1
		}
	...
	pe.extend({
		...
		ajax: function (t, n) {
			...
			if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, f.url = ((t || f.url || $t) + "").replace(/#.*$/, "").replace(/^\/\//, zt[1] + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = pe.trim(f.dataType || "*").toLowerCase().match(Ne) || [""], null == f.crossDomain && (i = Pt.exec(f.url.toLowerCase()), f.crossDomain = !(!i || i[1] === zt[1] && i[2] === zt[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (zt[3] || ("http:" === zt[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = pe.param(f.data, f.traditional)), U(Bt, f, n, T), 2 === b) return T;
			l = pe.event && f.global, l && 0 == pe.active++ && pe.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Rt.test(f.type), a = f.url, f.hasContent || (f.data && (a = f.url += (_t.test(a) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (f.url = Ft.test(a) ? a.replace(Ft, "$1_=" + qt++) : a + (_t.test(a) ? "&" : "?") + "_=" + qt++)), f.ifModified && (pe.lastModified[a] && T.setRequestHeader("If-Modified-Since", pe.lastModified[a]), pe.etag[a] && T.setRequestHeader("If-None-Match", pe.etag[a])), (f.data && f.hasContent && f.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", f.contentType), T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + It + "; q=0.01" : "") : f.accepts["*"]);
	...
	pe.param = function (e, t) {
		...
		serializeArray: function () {
			return this.map(function () {
				...
				var e = this.type;
				return this.name && !pe(this).is(":disabled") && Vt.test(this.nodeName) && !Ut.test(e) && (this.checked || !Me.test(e))
			}).map(function (e, t) {
				var n = pe(this).val();
	...
	var Yt = 0,
		Jt = {},
		Gt = pe.ajaxSettings.xhr();
	e.attachEvent && e.attachEvent("onunload", function () {
		for (var e in Jt) Jt[e](void 0, !0)
	}), de.cors = !!Gt && "withCredentials" in Gt, (Gt = de.ajax = !!Gt) && pe.ajaxTransport(function (t) {
				...
				send: function (r, i) {
					...
					a.send(t.hasContent && t.data || null), n = function (e, r) {
						...
						if (n && (r || 4 === a.readyState))
							if (delete Jt[s], n = void 0, a.onreadystatechange = pe.noop, r) 4 !== a.readyState && a.abort();
							else {
					...
					}, t.async ? 4 === a.readyState ? e.setTimeout(n) : a.onreadystatechange = Jt[s] = n : n()
				},
				abort: function () {
					n && n(void 0, !0)
				}
	...
	pe.ajaxSetup({
		...
		return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = pe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Kt, "$1" + i) : t.jsonp !== !1 && (t.url += (_t.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
			return a || pe.error(i + " was not called"), a[0]
		}, t.dataTypes[0] = "json", o = e[i], e[i] = function () {
			a = arguments
		}, r.always(function () {
			void 0 === o ? pe(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Qt.push(i)), a && pe.isFunction(o) && o(a[0]), a = o = void 0
		}), "script") : void 0
	...
	pe.fn.load = function (e, t, n) {
		...
		pe.cssHooks[t] = L(de.pixelPosition, function (e, n) {
			return n ? (n = lt(e, t), ot.test(n) ? pe(e).position()[t] + "px" : n) : void 0
		})
	}), pe.each({
		Height: "height",
		Width: "width"
	...
	return pe.noConflict = function (t) {
		return e.$ === pe && (e.$ = tn), t && e.jQuery === pe && (e.jQuery = en), pe
	}, t || (e.jQuery = e.$ = pe), pe
});
	...
	function (e, t, r) {
		...
		function o(t, r, o, a) {
			if (Object.defineProperty) try {
				return void Object.defineProperty(t, r, {
					configurable: !0,
					enumerable: !0,
					get: function () {
						return n(a), o
		...
		var a = {};
		e.migrateWarnings = [], t.console && t.console.log && t.console.log("JQMIGRATE: Migrate is installed" + (e.migrateMute ? "" : " with logging active") + ", version " + e.migrateVersion), e.migrateTrace === r && (e.migrateTrace = !0), e.migrateReset = function () {
		...
		o(e, "attrFn", i || {}, "jQuery.attrFn is deprecated"), e.attr = function (t, o, a, c) {
			var u = o.toLowerCase(),
				h = t && t.nodeType;
			return c && (s.length < 4 && n("jQuery.fn.attr( props, pass ) is deprecated"), t && !l.test(h) && (i ? o in i : e.isFunction(e.fn[o]))) ? e(t)[o](a) : ("type" === o && a !== r && d.test(t.nodeName) && t.parentNode && n("Can't change the 'type' of an input or button in IE 6/7/8"), !e.attrHooks[u] && p.test(u) && (e.attrHooks[u] = {
				get: function (t, n) {
					var o, a = e.prop(t, n);
					return a === !0 || "boolean" != typeof a && (o = t.getAttributeNode(n)) && o.nodeValue !== !1 ? n.toLowerCase() : r
				},
				set: function (t, r, n) {
					var o;
					return r === !1 ? e.removeAttr(t, n) : (o = e.propFix[n] || n, o in t && (t[o] = !0), t.setAttribute(n, n.toLowerCase())), n
				}
			}, f.test(u) && n("jQuery.fn.attr('" + u + "') might use property instead of attribute")), s.call(e, t, o, a))
		}, e.attrHooks.value = {
			get: function (e, t) {
				var r = (e.nodeName || "").toLowerCase();
				return "button" === r ? c.apply(this, arguments) : ("input" !== r && "option" !== r && n("jQuery.fn.attr('value') no longer gets properties"), t in e ? e.value : null)
			},
			set: function (e, t) {
				var r = (e.nodeName || "").toLowerCase();
				return "button" === r ? u.apply(this, arguments) : ("input" !== r && "option" !== r && n("jQuery.fn.attr('value', val) no longer sets properties"), void(e.value = t))
			}
		};
		var h, v, g = e.fn.init,
			m = e.parseJSON,
			...
			b = /\[\s*\w+\s*[~|^$*]?=\s*(?![\s'"])[^#\]]*#/,
			j = /^([^<]*)(<[\w\W]+>)([^>]*)$/;
		e.fn.init = function (t, o, a) {
			var i, s;
			return t && "string" == typeof t && !e.isPlainObject(o) && (i = j.exec(e.trim(t))) && i[0] && (y.test(t) || n("$(html) HTML strings must start with '<' character"), i[3] && n("$(html) HTML text after last tag is ignored"), "#" === i[0].charAt(0) && (n("HTML string cannot start with a '#' character"), e.error("JQMIGRATE: Invalid selector string (XSS)")), o && o.context && (o = o.context), e.parseHTML) ? g.call(this, e.parseHTML(i[2], o && o.ownerDocument || o || document, !0), o, a) : ("#" === t ? (n("jQuery( '#' ) is not a valid selector"), t = []) : b.test(t) && n("Attribute selectors with '#' must be quoted: '" + t + "'"), s = g.apply(this, arguments), t && t.selector !== r ? (s.selector = t.selector, s.context = t.context) : (s.selector = "string" == typeof t ? t : "", t && (s.context = t.nodeType ? t : o || document)), s)
		}, e.fn.init.prototype = e.fn, e.parseJSON = function (e) {
			return e ? m.apply(this, arguments) : (n("jQuery.parseJSON requires a valid JSON string"), null)
			...
			e.extend(!0, t, this), t.superclass = this, t.fn = t.prototype = this(), t.fn.constructor = t, t.sub = this.sub, t.fn.init = function (n, o) {
				var a = e.fn.init.call(this, n, o, r);
				return a instanceof t ? a : t(a)
		...
		e.fn.data = function (t) {
			var o, a, i = this[0];
			return !i || "events" !== t || 1 !== arguments.length || (o = e.data(i, t), a = e._data(i, t), o !== r && o !== a || a === r) ? x.apply(this, arguments) : (n("Use of jQuery.fn.data('events') is deprecated"), a)
		};
		var Q = /\/(java|ecma)script/i;
		e.clean || (e.clean = function (t, r, o, a) {
			r = r || document, r = !r.nodeType && r[0] || r, r = r.ownerDocument || r, n("jQuery.clean() is deprecated");
			var i, s, c, u, d = [];
			if (e.merge(d, e.buildFragment(t, r).childNodes), o)
				for (c = function (e) {
						return !e.type || Q.test(e.type) ? a ? a.push(e.parentNode ? e.parentNode.removeChild(e) : e) : o.appendChild(e) : void 0
					}, i = 0; null != (s = d[i]); i++) e.nodeName(s, "script") && c(s) || (o.appendChild(s), void 0 !== s.getElementsByTagName && (u = e.grep(e.merge([], s.getElementsByTagName("script")), c), d.splice.apply(d, [i + 1, 0].concat(u)), i += u.length));
			return d
		});
		var k = e.event.add,
			M = e.event.remove,
			...
			F = /(?:^|\s)hover(\.\S+|)\b/,
			R = function (t) {
				return "string" != typeof t || e.event.special.hover ? t : (F.test(t) && n("'hover' pseudo-event is deprecated, use 'mouseenter mouseleave'"), t && t.replace(F, "mouseenter$1 mouseleave$1"))
			};
		e.event.props && "attrChange" !== e.event.props[0] && e.event.props.unshift("attrChange", "attrName", "relatedNode", "srcElement"), e.event.dispatch && o(e.event, "handle", e.event.dispatch, "jQuery.event.handle is undocumented and deprecated"), e.event.add = function (e, t, r, o, a) {
			e !== document && L.test(t) && n("AJAX events should be attached to document: " + t), k.call(this, e, R(t || ""), r, o, a)
		}, e.event.remove = function (e, t, r, n, o) {
			M.call(this, e, R(t) || "", r, n, o)
		}, e.each(["load", "unload", "error"], function (t, r) {
			e.fn[r] = function () {
				var e = Array.prototype.slice.call(arguments, 0);
				return "load" === r && "string" == typeof e[0] ? H.apply(this, e) : (n("jQuery.fn." + r + "() is deprecated"), e.splice(0, 0, r), arguments.length ? this.bind.apply(this, e) : (this.triggerHandler.apply(this, e), this))
			}
		}), e.fn.toggle = function (t, r) {
			if (!e.isFunction(t) || !e.isFunction(r)) return N.apply(this, arguments);
			n("jQuery.fn.toggle(handler, handler...) is deprecated");
			var o = arguments,
				a = t.guid || e.guid++,
				i = 0,
				s = function (r) {
					var n = (e._data(this, "lastToggle" + t.guid) || 0) % i;
					return e._data(this, "lastToggle" + t.guid, n + 1), r.preventDefault(), o[n].apply(this, arguments) || !1
				};
			for (s.guid = a; i < o.length;) o[i++].guid = a;
			return this.click(s)
		}, e.fn.live = function (t, r, o) {
			return n("jQuery.fn.live() is deprecated"), S ? S.apply(this, arguments) : (e(this.context).on(t, this.selector, r, o), this)
		}, e.fn.die = function (t, r) {
			return n("jQuery.fn.die() is deprecated"), T ? T.apply(this, arguments) : (e(this.context).off(t, this.selector || "**", r), this)
		}, e.event.trigger = function (e, t, r, o) {
			return r || L.test(e) || n("Global events are undocumented and deprecated"), C.call(this, e, t, r || document, o)
		}, e.each(A.split("|"), function (t, r) {
			e.event.special[r] = {
				setup: function () {
					var t = this;
					return t !== document && (e.event.add(document, r + "." + e.guid, function () {
						e.event.trigger(r, Array.prototype.slice.call(arguments, 1), t, !0)
					}), e._data(this, r, e.guid++)), !1
				},
				teardown: function () {
					return this !== document && e.event.remove(document, r + "." + e._data(this, r)), !1
				}
			}
		...
		var $ = e.fn.andSelf || e.fn.addBack,
			E = e.fn.find;
		if (e.fn.andSelf = function () {
				return n("jQuery.fn.andSelf() replaced by jQuery.fn.addBack()"), $.apply(this, arguments)
			...
			e.Deferred = function (t) {
				...
				return r.pipe = o.pipe = function () {
					...
					return n("deferred.isResolved is deprecated"), "resolved" === r.state()
				}, r.isRejected = function () {
					return n("deferred.isRejected is deprecated"), "rejected" === r.state()
				}, t && t.call(r, r), r
			}
		}
	}(jQuery, window);
			...
			return this.each(function () {
				function o(t) {
					if (h) {
						t = t || window.event;
						var i = 0;
						t.wheelDelta && (i = -t.wheelDelta / 120), t.detail && (i = t.detail / 3), e(t.target || t.srcTarget || t.srcElement).closest("." + s.wrapperClass).is(w.parent()) && a(i, !0), t.preventDefault && !v && t.preventDefault(), v || (t.returnValue = !1)
					}
				}

				function a(e, t, i) {
					v = !1;
					var o = w.outerHeight() - y.outerHeight();
					t && (t = parseInt(y.css("top")) + e * parseInt(s.wheelStep) / 100 * y.outerHeight(), t = Math.min(Math.max(t, 0), o), t = 0 < e ? Math.ceil(t) : Math.floor(t), y.css({
						top: t + "px"
					})), f = parseInt(y.css("top")) / (w.outerHeight() - y.outerHeight()), t = f * (w[0].scrollHeight - w.outerHeight()), i && (t = e, e = t / w[0].scrollHeight * w.outerHeight(), e = Math.min(Math.max(e, 0), o), y.css({
						top: e + "px"
					})), w.scrollTop(t), w.trigger("slimscrolling", ~~t), l(), n()
				}

				function r() {
					g = Math.max(w.outerHeight() / w[0].scrollHeight * w.outerHeight(), 30), y.css({
						height: g + "px"
					});
					var e = g == w.outerHeight() ? "none" : "block";
					y.css({
						display: e
					})
				}
				...
				function l() {
					r(), clearTimeout(d), f == ~~f ? (v = s.allowPageScroll, b != f && w.trigger("slimscroll", 0 == ~~f ? "top" : "bottom")) : v = !1, b = f, g >= w.outerHeight() ? v = !0 : (y.stop(!0, !0).fadeIn("fast"), s.railVisible && x.stop(!0, !0).fadeIn("fast"))
				}

				function n() {
					s.alwaysVisible || (d = setTimeout(function () {
						s.disableFadeOut && h || c || u || (y.fadeOut("slow"), x.fadeOut("slow"))
					}, 1e3))
				}
				var h, c, u, d, p, g, f, b, v = !1,
					w = e(this);
				if (w.parent().hasClass(s.wrapperClass)) {
					var m = w.scrollTop(),
						y = w.siblings("." + s.barClass),
						x = w.siblings("." + s.railClass);
					if (r(), e.isPlainObject(i)) {
						...
						} else "height" in i && (C = i.height, w.parent().css("height", C), w.css("height", C));
						if ("scrollTo" in i) m = parseInt(s.scrollTo);
						else if ("scrollBy" in i) m += parseInt(s.scrollBy);
						else if ("destroy" in i) return y.remove(), x.remove(), void w.unwrap();
						a(m, !1, !0)
					}
				} else if (!(e.isPlainObject(i) && "destroy" in i)) {
					s.height = "auto" == s.height ? w.parent().height() : s.height, m = e("<div></div>").addClass(s.wrapperClass).css({
						position: "relative",
						overflow: "hidden",
						width: s.width,
						height: s.height
					...
					var x = e("<div></div>").addClass(s.railClass).css({
							width: s.size,
							height: "100%",
							position: "absolute",
							top: 0,
						...
						y = e("<div></div>").addClass(s.barClass).css({
							background: s.color,
							width: s.size,
							position: "absolute",
							top: 0,
					...
					x.css(C), y.css(C), w.wrap(m), w.parent().append(y), w.parent().append(x), s.railDraggable && y.bind("mousedown", function (i) {
						var s = e(document);
						return u = !0, t = parseFloat(y.css("top")), pageY = i.pageY, s.bind("mousemove.slimscroll", function (e) {
							currTop = t + e.pageY - pageY, y.css("top", currTop), a(0, y.position().top, !1)
						...
						v || e.originalEvent.preventDefault(), e.originalEvent.touches.length && (a((p - e.originalEvent.touches[0].pageY) / s.touchScrollStep, !0), p = e.originalEvent.touches[0].pageY)
					}), r(), "bottom" === s.start ? (y.css({
						top: w.outerHeight() - y.outerHeight()
					}), a(0, !0)) : "top" !== s.start && (a(e(s.start).position().top, null, !0), s.alwaysVisible || y.hide()), window.addEventListener ? (this.addEventListener("DOMMouseScroll", o, !1), this.addEventListener("mousewheel", o, !1)) : document.attachEvent("onmousewheel", o)
				}
			}), this
		}
	}), e.fn.extend({
...
function _init() {
	...
	$.AdminLTE.layout = {
		...
		fix: function () {
			...
			var e = $(".main-footer").outerHeight() || 0,
				i = $(".main-header").outerHeight() + e,
				o = $(window).height(),
				n = $(".sidebar").height() || 0;
			if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", o - e);
				...
				void 0 !== s && s.height() > t && $(".content-wrapper, .right-side").css("min-height", s.height())
			}
		},
		fixSidebar: function () {
		...
		activate: function (e) {
			var i = $.AdminLTE.options.screenSizes;
			$(document).on("click", e, function (e) {
				e.preventDefault(), $(window).width() > i.sm - 1 ? $("body").hasClass("sidebar-collapse") ? $("body").removeClass("sidebar-collapse").trigger("expanded.pushMenu") : $("body").addClass("sidebar-collapse").trigger("collapsed.pushMenu") : $("body").hasClass("sidebar-open") ? $("body").removeClass("sidebar-open").removeClass("sidebar-collapse").trigger("collapsed.pushMenu") : $("body").addClass("sidebar-open").trigger("expanded.pushMenu")
			}), $(".content-wrapper").click(function () {
				$(window).width() <= i.sm - 1 && $("body").hasClass("sidebar-open") && $("body").removeClass("sidebar-open")
			}), ($.AdminLTE.options.sidebarExpandOnHover || $("body").hasClass("fixed") && $("body").hasClass("sidebar-mini")) && this.expandOnHover()
		},
		expandOnHover: function () {
			var e = this,
				i = $.AdminLTE.options.screenSizes.sm - 1;
			$(".main-sidebar").hover(function () {
				$("body").hasClass("sidebar-mini") && $("body").hasClass("sidebar-collapse") && $(window).width() > i && e.expand()
			}, function () {
				$("body").hasClass("sidebar-mini") && $("body").hasClass("sidebar-expanded-on-hover") && $(window).width() > i && e.collapse()
			})
		},
		expand: function () {
		...
		var i = this,
			o = $.AdminLTE.options.animationSpeed;
		$(document).off("click", e + " li a").on("click", e + " li a", function (e) {
			var n = $(this),
				t = n.next();
			if (t.is(".treeview-menu") && t.is(":visible") && !$("body").hasClass("sidebar-collapse")) t.slideUp(o, function () {
				...
				t.slideDown(o, function () {
					t.addClass("menu-open"), s.find("li.active").removeClass("active"), r.addClass("active"), i.layout.fix()
				})
			}
		...
		activate: function () {
			var e = this,
				i = $.AdminLTE.options.controlSidebarOptions,
				o = $(i.selector);
			$(i.toggleBtnSelector).on("click", function (n) {
				n.preventDefault(), o.hasClass("control-sidebar-open") || $("body").hasClass("control-sidebar-open") ? e.close(o, i.slide) : e.open(o, i.slide)
			});
			var n = $(".control-sidebar-bg");
			e._fix(n), $("body").hasClass("fixed") ? e._fixForFixed(o) : $(".content-wrapper, .right-side").height() < o.height() && e._fixForContent(o)
		},
		open: function (e, i) {
			i ? e.addClass("control-sidebar-open") : $("body").addClass("control-sidebar-open")
		},
		close: function (e, i) {
			i ? e.removeClass("control-sidebar-open") : $("body").removeClass("control-sidebar-open")
		},
		_fix: function (e) {
			var i = this;
			if ($("body").hasClass("layout-boxed")) {
				if (e.css("position", "absolute"), e.height($(".wrapper").height()), i.hasBindedResize) return;
		...
		activate: function (e) {
			var i = this;
			e || (e = document), $(e).on("click", i.selectors.collapse, function (e) {
				e.preventDefault(), i.collapse($(this))
			}), $(e).on("click", i.selectors.remove, function (e) {
				e.preventDefault(), i.remove($(this))
			})
		},
		collapse: function (e) {
			var i = this,
				o = e.parents(".box").first(),
				n = o.find("> .box-body, > .box-footer, > form  >.box-body, > form > .box-footer");
			o.hasClass("collapsed-box") ? (e.children(":first").removeClass(i.icons.open).addClass(i.icons.collapse), n.slideDown(i.animationSpeed, function () {
				o.removeClass("collapsed-box")
			})) : (e.children(":first").removeClass(i.icons.collapse).addClass(i.icons.open), n.slideUp(i.animationSpeed, function () {
				o.addClass("collapsed-box")
			}))
		},
		remove: function (e) {
...
$.AdminLTE = {}, $.AdminLTE.options = {
		...
		_init(), $.AdminLTE.layout.activate(), e.enableControlTreeView && $.AdminLTE.tree(".sidebar"), e.enableControlSidebar && $.AdminLTE.controlSidebar.activate(), e.navbarMenuSlimscroll && void 0 !== $.fn.slimscroll && $(".navbar .menu").slimscroll({
			...
			var e = $(this);
			$(this).find(".btn").on("click", function (i) {
				e.find(".btn.active").removeClass("active"), $(this).addClass("active"), i.preventDefault()
			})
		})
	}),
	function (e) {
		"use strict";
		e.fn.boxRefresh = function (i) {
			function o(e) {
				e.append(s), t.onLoadStart.call(e)
			}

			function n(e) {
				e.find(s).remove(), t.onLoadDone.call(e)
			}
			var t = e.extend({
					trigger: ".refresh-btn",
					source: "",
				...
				s = e('<div class="overlay"><div class="fa fa-refresh fa-spin"></div></div>');
			return this.each(function () {
				if ("" === t.source) return void(window.console && window.console.log("Please specify a source first - boxRefresh()"));
				var i = e(this);
				i.find(t.trigger).first().on("click", function (e) {
					e.preventDefault(), o(i), i.find(".box-body").load(t.source, function () {
						n(i)
					})
				})
			})
	...
	function (e) {
		...
		e.fn.activateBox = function () {
			...
			var i = e(e.AdminLTE.boxWidget.selectors.collapse, this);
			e.AdminLTE.boxWidget.collapse(i)
		}, e.fn.removeBox = function () {
			var i = e(e.AdminLTE.boxWidget.selectors.remove, this);
			e.AdminLTE.boxWidget.remove(i)
		}
	}(jQuery),
	function (e) {
		"use strict";
		e.fn.todolist = function (i) {
			var o = e.extend({
				onCheck: function (e) {
					return e
				},
			...
			return this.each(function () {
				void 0 !== e.fn.iCheck ? (e("input", this).on("ifChecked", function () {
					...
					i.toggleClass("done"), o.onCheck.call(i)
				}), e("input", this).on("ifUnchecked", function () {
					var i = e(this).parents("li").first();
					i.toggleClass("done"), o.onUncheck.call(i)
				})) : e("input", this).on("change", function () {
					var i = e(this).parents("li").first();
					i.toggleClass("done"), e("input", i).is(":checked") ? o.onCheck.call(i) : o.onUncheck.call(i)
				})
			})
		}
	}(jQuery);
