...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2019 at 04:10 AM
...
(2, '127.0.0.1', 'admin', '$2y$08$7Bkco6JXtC3Hu6g9ngLZDuHsFLvT7cyAxiz1FzxlX5vwccvRT7nKW', NULL, NULL, NULL, NULL, NULL, NULL, 1451900228, 1550654805, 1, 'Admin', ''),
...
(2, 'coba lagi', 'kenapa', 'kenapa aja sih<br>', '2019-02-15', 1);
...
--
ALTER TABLE `parent_category`
  MODIFY `ID_PARENT_CATEGORY` int(11) NOT NULL AUTO_INCREMENT;
