...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2019 at 09:18 AM
...
(1, '127.0.0.1', 'webmaster', '$2y$08$VbBl6laOs0UEbQyQUAjXq.kp0pR8D8GvPXSTdb3xC2aU2S6tB3r8y', NULL, NULL, NULL, NULL, NULL, NULL, 1451900190, 1550456531, 1, 'Webmaster', ''),
(2, '127.0.0.1', 'admin', '$2y$08$7Bkco6JXtC3Hu6g9ngLZDuHsFLvT7cyAxiz1FzxlX5vwccvRT7nKW', NULL, NULL, NULL, NULL, NULL, NULL, 1451900228, 1551166453, 1, 'Admin', ''),
(3, '::1', 'editor', '$2y$08$mi0X9Z96FC8r7VPxWC3xLeYljtV.oe4I7Sv6clPDufU6SqVAqonca', NULL, NULL, NULL, NULL, NULL, NULL, 1550466617, 1550559041, 1, 'editor', ''),
(4, '::1', 'author', '$2y$08$YPvIv4938ZKSxoio3FvUlOqV5wzY37Baaf43iuLJsARvq0BHRir1a', NULL, NULL, NULL, NULL, NULL, NULL, 1550466626, 1550466721, 1, 'author', '');
...
INSERT INTO `category` (`ID_CATEGORY`, `ID_PARENT_CATEGORY`, `NAME_CATEGORY`, `SLUG_CATEGORY`, `STATUS_CATEGORY`) VALUES
(1, 1, 'Liga Inggris', 'liga-inggris', 1),
(2, 1, 'Liga Indonesia', 'liga-indonesia', 0),
(3, 2, 'Bisnis', 'bisnis', 1),
(4, 2, 'Pasar', 'pasar', 1);
...
(2, 'test ke 2', 'Ini hanyalah percobaan ke 2', '49b35-itachi.jpg', '#naruto#itachi');
...
CREATE TABLE `parent_category` (
  `ID_PARENT_CATEGORY` int(11) NOT NULL,
  `NAME_PARENT_CATEGORY` varchar(50) DEFAULT NULL,
  `DESCRIPTION` text,
...
INSERT INTO `parent_category` (`ID_PARENT_CATEGORY`, `NAME_PARENT_CATEGORY`, `DESCRIPTION`, `IS_ACTIVE`) VALUES
(1, 'Sepak Bola', 'Olahraga sepak bola di berbagai belahan dunia', 1),
(2, 'Ekonomi', 'Seputar perekonomian dunia', 1),
(3, 'Kesehatan', 'Kesehatan masyarakat', 1);
...
ALTER TABLE `category`
  ADD PRIMARY KEY (`ID_CATEGORY`,`ID_PARENT_CATEGORY`),
...
ALTER TABLE `parent_category`
  ADD PRIMARY KEY (`ID_PARENT_CATEGORY`);
...
--
ALTER TABLE `parent_category`
  MODIFY `ID_PARENT_CATEGORY` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `category`
  ADD CONSTRAINT `FK_CATEGORY_HAVE_PARENT` FOREIGN KEY (`ID_PARENT_CATEGORY`) REFERENCES `parent_category` (`ID_PARENT_CATEGORY`);
COMMIT;
